...
const Pagination = () => {
    ...
    console.log(Math.ceil(totalPages/perPage))
    ...
    return (
        ...
        <div className='flex items-center'>
            ...
            <ul className='flex items-center justify-end text-sm'>
                ...
                {
                    (page-1 !== 0)?(<li><button onClick={prev} className='outline-0 hover:text-cyan rounded-full w-8 h-8 flex items-center justify-center bg-gray-200 mx-1.5'>{page-1}</button></li>):null
                }
                <li><button disabled className='outline-0 hover:text-cyan rounded-full w-8 h-8 flex items-center justify-center  bg-cyan text-gray-300 mx-1.5'>{page}</button></li>
               {
                (page+1 !== TotalNumber &&  page !== TotalNumber )?( <li><button onClick={next} className='outline-0 hover:text-cyan rounded-full w-8 h-8 flex items-center justify-center  bg-gray-200 mx-1.5'>{page+1}</button></li>):null
               }
                {
