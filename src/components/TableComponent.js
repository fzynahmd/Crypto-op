...
const TableComponent = () => {
  ...
  return (
          ...
          >
            {cryptoData.map((data) => {
              return (
                <tr
                  key={data.id}
                  className="text-centre text-base border-b border-gray-100 hover:bg-gray-200 last:border-b-0"
                >
                  ...
                  <td className={
                    data.market_cap_change_percentage_24h>0 ? 'text-green py-4':'text-red py-4'
    ...
    <div className="flex items-center justify-between mt-4 capitalize h-[2rem]">
        <span>Data provided by <a className="text-cyan" href="http://www.coingecko.com" rel="noreferrer" target="__blank">CoinGecko</a></span>
      <Pagination/>
      </div>
    </>
  );
